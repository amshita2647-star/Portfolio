    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 bg-gradient-to-b from-background to-background/50">
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6">
          <div className="inline-block px-4 py-2 rounded-full bg-card border border-cyan-500/30 text-cyan-400 text-sm font-medium">
        ...
        >
          Tackling real-world challenges through software engineering excellence. From low-level systems programming to intelligent AI-driven platforms.
        </motion.p>
